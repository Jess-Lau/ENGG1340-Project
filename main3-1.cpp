...
int main() {
    ...
    while (1) {
        ...
        vector<string> validRooms = {"Liminal Space","Mirror Maze","Meat Locker","Quicksand","Bazaar","Dojo","Bat Cavern","Volcano"};
        switch (zombie.direction) {
            case 'n':
                if (find(std::begin(validRooms), end(validRooms), room[currentRoomNumber].north) != end(validRooms)) {
                ...
                break;
            case_s:
                if (find(std::begin(validRooms), end(validRooms), room[currentRoomNumber].south) != end(validRooms)) {
                ...
                break;
            case 'e':
                if (find(std::begin(validRooms), end(validRooms), room[currentRoomNumber].east) != end(validRooms)) {
            ...
            case_e:
                ...
                break;
            case 'w':
                if (find(std::begin(validRooms), end(validRooms), room[currentRoomNumber].west) != end(validRooms)) {
